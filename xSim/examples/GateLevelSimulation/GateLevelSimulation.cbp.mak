...
Debug_target.BIN = bin/Debug/GateLevelSimulation.exe
Debug_target.OBJ = CircuitReader.o DriverLogicalProcess.o GateLogicalProcess.o LogicEvent.o MonitorLogicalProcess.o main.o 
DEP_FILES += CircuitReader.d DriverLogicalProcess.d GateLogicalProcess.d LogicEvent.d MonitorLogicalProcess.d main.d 
...
Debug_target : LDFLAGS += -lpthread -L../../../Parvicursor/System.Threading/Thread -L../../../ParvicursorLib/bin/Debug -L../../../xSimLib/bin/Debug   
